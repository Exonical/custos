...
| TM-08 | SSRF via cluster endpoint or webhook URLs | T3, T9 | I, E | Only platform admins register clusters; scheme/host allow-lists; block link-local/metadata/loopback; DNS re-resolution check in dialer; no user-supplied URLs fetched in v1 |
